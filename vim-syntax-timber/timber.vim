...
syn match hsStructure		"\<\(typeclass\|class\|struct\|data\|default\|deriving\|instance\|where\)\>"
syn match hsTypedef		"\<\(action\|after\|before\|request\|result\|return\|type\|new\|newtype\|private\|use\)\>"
syn match hsStatement		"\<\(do\|forall\|case\|of\|let\|in\)\>"
syn match hsConditional		"\<\(if\|then\|else\|elsif\)\>"
...
if exists("hs_highlight_types")
  ...
  syn match hsType "\<\(Action\|Request\|Int\|Integer\|Char\|Bool\|Float\|Double\|IO\|Void\|Addr\|Array\|String\)\>"
endif
...
" Accept %: for # (C99)
syn region	cPreCondit	start="^\s*\(%:\|#\)\s*\(if\|elsif\|ifdef\|ifndef\|elif\)\>" skip="\\$" end="$" end="//"me=s-1 contains=cComment,cCppString,cCommentError
